...
__all__ = [
    'SpeechMicTraining', 'SpFileStream', 'DISPID_SPEAudioSizeBytes',
    'SPPHRASERULE', 'SAFTADPCM_8kHzStereo', 'SDTReplacement',
    'DISPID_SDKEnumKeys', 'SAFT48kHz16BitStereo',
    'SPEI_SR_RETAINEDAUDIO', 'SpeechPropertyComplexResponseSpeed',
    'SPSLMA', 'ISpeechPhraseElement', 'DISPID_SpeechDataKey',
    'DISPID_SMSAMMHandle', 'DISPID_SVEPhoneme',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SLAddPronunciation', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SGRSTRule', 'DISPID_SOTIsUISupported',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SVSVisemeId', 'SpeechVoiceCategoryTTSRate',
    'eLEXTYPE_PRIVATE18', 'DISPID_SPILanguageId', 'SPAUDIOOPTIONS',
    'SAFT24kHz16BitStereo', 'DISPID_SPPBRestorePhraseFromMemory',
    'SpeechAudioFormatType', 'SDKLLocalMachine',
    'SPINTERFERENCE_TOOLOUD', 'SPEVENT', 'DISPID_SMSADeviceId',
    'DISPID_SVSpeakStream', 'SP_VISEME_0', 'ISpeechPhraseProperty',
    'SAFTADPCM_22kHzStereo', 'SAFTGSM610_8kHzMono', 'SPSNotOverriden',
    'ISpRecognizer2', 'SPWORD', 'SpCustomStream',
    'DISPID_SPPConfidence', 'ISpeechRecoResult2',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'tagSPPROPERTYINFO',
    'SPEI_UNDEFINED', 'eLEXTYPE_PRIVATE15',
    'SpeechTokenIdUserLexicon', 'SWPKnownWordPronounceable',
    'DISPID_SVSInputWordPosition', 'DISPID_SLWs_NewEnum',
    'SpeechLoadOption', 'SRERecognition',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpUnCompressedLexicon',
    'SPLO_STATIC', 'SITooQuiet', 'SITooSlow', 'SP_VISEME_8',
    'SPGRAMMARWORDTYPE', 'DISPID_SLPSymbolic', 'SPPHRASEREPLACEMENT',
    'ISpRecognizer3', 'SPSNoun', 'DISPID_SVEAudioLevel',
    'DISPID_SRGSetWordSequenceData', 'SREStreamEnd', 'SPFM_NUM_MODES',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPRs_NewEnum',
    'Speech_StreamPos_Asap', 'DISPID_SCSBaseStream',
    'DISPID_SRGCommit', 'ISpNotifyTranslator', 'ISpeechAudioFormat',
    'STCInprocServer', 'SVSFParseSsml', 'SAFTADPCM_44kHzStereo',
    'DISPID_SPIEngineId', 'SINoise', 'IStream',
    'IInternetSecurityManager', 'DISPID_SBSRead', 'DISPID_SRRAudio',
    'STSF_CommonAppData', 'SP_VISEME_6',
    'SpeechVoiceSkipTypeSentence', 'SPGS_EXCLUSIVE',
    'eLEXTYPE_PRIVATE1', 'DISPID_SRCCreateGrammar',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SLGetWords',
    'SAFTCCITT_ALaw_44kHzStereo', 'Speech_Default_Weight',
    'DISPID_SBSFormat', 'SP_VISEME_2',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SpeechLexiconWord',
    'SSTTWildcard', 'ISpStreamFormat', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRCVoice', 'DISPID_SOTRemoveStorageFileName',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRAudioInputStream',
    'DISPID_SPRsCount', 'SBOPause', 'DISPID_SVGetVoices',
    'SVSFParseAutodetect', 'SpeechRegistryLocalMachineRoot',
    'ISpResourceManager', 'SAFTCCITT_uLaw_22kHzStereo', 'SPAS_PAUSE',
    'SpeechSpecialTransitionType', 'SPSSuppressWord', 'SREBookmark',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'WAVEFORMATEX', 'DISPID_SASState',
    'DISPID_SpeechVoiceEvent', 'DISPID_SOTCategory',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SVGetAudioInputs',
    'DISPIDSPTSI', 'DISPID_SVEventInterests', 'ISpShortcut',
    'DISPID_SPAStartElementInResult', 'DISPID_SRCEPhraseStart',
    'SP_VISEME_5', 'SINone', 'SpeechUserTraining',
    'ISpeechPhraseProperties', 'DISPID_SRCERequestUI',
    'eLEXTYPE_RESERVED4', 'ISpeechPhraseRules', 'DISPID_SDKDeleteKey',
    'SPSHT_Unknown', 'SpeechEngineProperties',
    'SDA_No_Trailing_Space', 'SITooFast', 'SAFTNonStandardFormat',
    'SREFalseRecognition', 'SECFIgnoreCase', 'DISPID_SVVoice',
    'SPCT_SUB_DICTATION', 'eLEXTYPE_RESERVED9', 'ISpRecoCategory',
    'SAFT22kHz16BitMono', 'SP_VISEME_9', 'DISPID_SRGetFormat',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechPhraseElements', 'SINoSignal',
    'SPXRO_Alternates_SML', 'DISPID_SVEEnginePrivate',
    'DISPID_SRCEEndStream', 'ISpeechPhraseRule', 'SVSFNLPSpeakPunc',
    'DISPID_SRStatus', 'ISpObjectToken', 'LONG_PTR', 'SPVPRIORITY',
    'DISPID_SPPChildren', 'ISpRecoContext2', 'SpWaveFormatEx',
    'DISPID_SOTGetAttribute', 'SAFT16kHz8BitStereo', 'SVP_16',
    'DISPID_SPIAudioSizeTime', 'SDKLCurrentUser', 'SPEI_REQUEST_UI',
    'DISPID_SBSSeek', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SVSpeakCompleteEvent',
    'SECFIgnoreKanaType', 'SPPS_Verb', 'DISPID_SGRSAddRuleTransition',
    'ISpeechAudio', 'ISpeechRecognizerStatus', 'DISPID_SPIStartTime',
    'SPDKL_DefaultLocation', 'DISPID_SRRecognizer', 'SDTDisplayText',
    'SAFT24kHz8BitMono', 'SPSHT_OTHER', 'eWORDTYPE_ADDED',
    'SREStateChange', 'DISPID_SPEs_NewEnum', 'DISPID_SGRsAdd',
    'SPBO_TIME_UNITS', 'SSFMCreateForWrite', 'ISpRecognizer',
    'ISpeechDataKey', 'SVSFVoiceMask', 'DISPID_SPEActualConfidence',
    'DISPID_SFSOpen', 'SAFTExtendedAudioFormat',
    'DISPID_SLWPronunciations', 'SGRSTTWildcard',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SVEWord',
    'STSF_FlagCreate', 'SpeechRecoEvents', 'SpShortcut',
    'SPEI_PHRASE_START', 'SREPrivate', 'DISPID_SDKOpenKey',
    'SRTReSent', 'SpeechStreamFileMode', 'DISPID_SVDisplayUI',
    'DISPID_SOTSetId', 'DISPID_SpeechLexiconPronunciation',
    'SPCONTEXTSTATE', 'SRCS_Enabled', 'eLEXTYPE_PRIVATE12',
    'SpeechGrammarState', 'DISPID_SRCESoundStart', 'SVSFIsNotXML',
    'DISPID_SPPNumberOfElements', 'DISPID_SRCEHypothesis',
    'ISpeechLexicon', 'SGDSInactive', 'SpeechGrammarTagDictation',
    'SVSFUnusedFlags', 'ISpRecoContext', 'DISPID_SRSetPropertyNumber',
    'SPVOICESTATUS', 'DISPID_SPAsCount', 'SASPause', 'SASRun',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SpeechLexiconWords',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechPhraseRule',
    'SpeechEmulationCompareFlags', 'SPVPRI_OVER', 'DISPID_SRProfile',
    'DISPID_SDKGetStringValue', 'SITooLoud', 'ISpeechGrammarRules',
    'SVSFIsXML', 'SPSModifier', 'eLEXTYPE_PRIVATE14',
    'SPDATAKEYLOCATION', 'SDKLDefaultLocation',
    'DISPID_SpeechObjectTokenCategory', 'SGRSTTTextBuffer',
    'DISPID_SPRuleParent', 'SpMMAudioEnum', 'DISPID_SpeechRecognizer',
    'SPSERIALIZEDPHRASE', 'SPSInterjection',
    'DISPID_SGRSTPropertyValue', 'DISPID_SDKSetStringValue',
    'DISPID_SRCRequestedUIType', 'DISPID_SRCResume',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SpeechPhraseReplacements',
    'SP_VISEME_13', 'SVEPrivate', 'DISPID_SDKGetBinaryValue',
    'DISPID_SGRSAddWordTransition', 'DISPID_SAStatus', 'SP_VISEME_15',
    'DISPID_SGRSRule', 'SPGS_ENABLED', 'SpeechAudioState',
    'SGDisplay', 'SPSTREAMFORMATTYPE', 'SRARoot', 'SPPS_Modifier',
    'SLTUser', 'SPEI_HYPOTHESIS', 'DISPID_SVEVoiceChange',
    'SPPS_RESERVED4', 'SAFT11kHz16BitMono', 'SpeechEngineConfidence',
    'DISPID_SVResume', 'DISPID_SRSClsidEngine', 'DISPID_SVPriority',
    'SP_VISEME_14', 'SpeechRecoProfileProperties', 'SRATopLevel',
    'DISPID_SAFSetWaveFormatEx', 'SPWT_DISPLAY', 'SPINTERFERENCE',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRGRules',
    'SpSharedRecoContext', 'SPFM_OPEN_READONLY',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SOTs_NewEnum',
    'SpeechTokenValueCLSID', 'DISPIDSPTSI_SelectionOffset',
    'SECNormalConfidence', '_ISpeechVoiceEvents',
    'DISPID_SRGSetTextSelection', 'SPAS_STOP', 'SPEI_RESERVED6',
    'DISPID_SGRId', 'DISPID_SLPs_NewEnum', 'SPSHORTCUTTYPE',
    'ISpeechPhraseReplacement', 'ISpNotifySource', 'DISPID_SVSpeak',
    'DISPID_SPELexicalForm', 'SpeechRuleAttributes',
    'DISPID_SVSLastBookmark', 'SpeechVoicePriority', 'SREAudioLevel',
    'SPXMLRESULTOPTIONS', 'DISPID_SLRemovePronunciation', 'SVP_20',
    'SSSPTRelativeToCurrentPosition', 'SpPhoneticAlphabetConverter',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPRuleName', 'SREStreamStart',
    'SFTSREngine', 'SPWORDPRONOUNCEABLE',
    'SpeechStreamSeekPositionType', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SOTsItem', 'ISequentialStream', 'SpeechAudioVolume',
    'SpeechAudioFormatGUIDText', 'DISPID_SGRName',
    'SPDKL_CurrentConfig', 'DISPID_SPIGetDisplayAttributes',
    ...
    'DISPID_SPRuleConfidence', 'SP_VISEME_3', 'SRESoundEnd',
    'SAFTDefault', 'SAFT11kHz8BitMono', 'SRAONone',
    'DISPID_SASetState', 'DISPID_SPCLangId', 'SDTAudio',
    'SVSFNLPMask', 'SPEI_PROPERTY_STRING_CHANGE', 'ISpLexicon',
    'SPPS_RESERVED3', 'DISPID_SRCreateRecoContext', 'SSTTTextBuffer',
    'SPRS_INACTIVE', 'DISPID_SpeechPhoneConverter',
    'ISpeechPhraseElements', 'SWPUnknownWordUnpronounceable',
    'SpMMAudioIn', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPAs_NewEnum', 'SVPAlert',
    'SAFTGSM610_22kHzMono', 'SpResourceManager', 'SVEAllEvents',
    'DISPID_SPPEngineConfidence', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRGCmdLoadFromResource', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SOTCId', 'DISPID_SRRSpeakAudio', 'SpCompressedLexicon',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPRST_NUM_STATES',
    'DISPID_SPRuleChildren', 'DISPID_SDKSetBinaryValue',
    'SRCS_Disabled', 'SPEI_RECOGNITION', 'SAFT8kHz8BitStereo',
    'DISPID_SRGDictationLoad', 'DISPID_SpeechRecoContextEvents',
    'SRERecoOtherContext', 'SPPHRASEELEMENT', 'DISPIDSPRG',
    'DISPID_SASCurrentSeekPosition', 'ISpRecoGrammar',
    'DISPID_SPPName', 'SpeechRunState', 'SPRECOGNIZERSTATUS',
    'SGLexicalNoSpecialChars', 'SWTAdded', 'SPEI_MAX_SR',
    'SDTLexicalForm', 'SpeechCategoryAudioIn', 'SPCS_ENABLED',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SPPParent',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRRPhraseInfo',
    'SAFT12kHz16BitStereo', 'DISPID_SPRulesCount',
    'SVESentenceBoundary', 'DISPID_SRCERecognizerStateChange',
    'SPPS_RESERVED1', 'DISPID_SVVolume', 'SRSActive',
    'SpeechFormatType', 'SVEStartInputStream', 'SPLOADOPTIONS',
    'DISPID_SOTDataKey', 'eLEXTYPE_PRIVATE9', 'SVP_0',
    'DISPID_SRGCmdLoadFromFile', 'SPEI_MIN_SR', 'DISPID_SPPs_NewEnum',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpVoice',
    'DISPID_SRRGetXMLResult', 'SGRSTTDictation', 'SPBINARYGRAMMAR',
    'ISpeechGrammarRuleState', 'ISpeechRecognizer', 'DISPID_SLPType',
    'DISPID_SAVolume', 'SpInProcRecoContext',
    'SPINTERFERENCE_NOSIGNAL', 'SPDKL_CurrentUser',
    'DISPID_SPEPronunciation', 'SPEI_RESERVED3', 'SpeechDiscardType',
    'SPEI_START_SR_STREAM', 'SVSFDefault', 'SREPropertyStringChange',
    'DISPID_SVESentenceBoundary', 'DISPID_SpeechBaseStream',
    'SPFM_CREATE', 'SPDKL_LocalMachine', 'SVSFPurgeBeforeSpeak',
    'SREInterference', 'DISPID_SABufferInfo', 'SREHypothesis',
    'SPRS_ACTIVE', 'SDA_One_Trailing_Space', 'DISPID_SVEStreamEnd',
    'SDKLCurrentConfig', 'DISPID_SVGetAudioOutputs', 'SPSMF_UPS',
    'DISPID_SpeechPhraseRules', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPWORDPRONUNCIATIONLIST', 'SpeechDictationTopicSpelling',
    'SDTPronunciation', 'DISPID_SRRTLength',
    'DISPID_SRGetRecognizers', 'SPCT_COMMAND',
    'ISpeechResourceLoader', 'DISPID_SpeechLexicon',
    'SPPS_SuppressWord', 'DISPID_SGRsFindRule',
    'DISPID_SPRFirstElement', 'eLEXTYPE_PRIVATE17',
    'SPWAVEFORMATTYPE', 'SP_VISEME_21', 'SPAUDIOSTATUS',
    'SpeechCategoryAudioOut', 'SpeechPropertyResourceUsage',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SSSPTRelativeToStart',
    'DISPID_SGRSTsCount', 'DISPID_SPIRule',
    'DISPID_SVAudioOutputStream', 'DISPID_SGRSTText', 'SP_VISEME_1',
    'ISpeechGrammarRule', 'SAFT44kHz16BitMono',
    'DISPID_SRCEInterference', 'SPLO_DYNAMIC',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRCEBookmark',
    'SpPhoneConverter', 'SRTExtendableParse', 'SVPNormal',
    'DISPID_SLWsItem', 'SpAudioFormat', 'eLEXTYPE_PRIVATE6',
    'SAFT12kHz8BitStereo', 'SAFTADPCM_44kHzMono',
    'DISPID_SGRSTs_NewEnum', 'SpeechRecognizerState',
    'DISPID_SFSClose', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPEsCount',
    'DISPID_SRGCmdSetRuleState', 'SpVoice', 'SVEVoiceChange',
    'SPWORDLIST', 'SGDSActiveUserDelimited', 'SPINTERFERENCE_NOISE',
    'DISPID_SVSInputWordLength', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRGCmdLoadFromMemory', '_SPAUDIOSTATE',
    'DISPIDSPTSI_ActiveLength',
    'DISPID_SRCERecognitionForOtherContext', 'eLEXTYPE_PRIVATE2',
    'SAFTText', 'SPEI_START_INPUT_STREAM', 'SECHighConfidence',
    'SPRST_INACTIVE_WITH_PURGE', 'SPEVENTENUM',
    'DISPID_SPRuleEngineConfidence', 'SpeechCategoryAppLexicons',
    'DISPID_SPPId', 'SPWT_LEXICAL', 'SAFT44kHz16BitStereo',
    'SAFTADPCM_8kHzMono', 'SPRECOCONTEXTSTATUS', 'SPPS_NotOverriden',
    'SPSEMANTICFORMAT', 'DISPID_SVGetProfiles',
    'DISPID_SRSCurrentStreamNumber', 'ISpGrammarBuilder',
    'Speech_Max_Word_Length', 'ISpeechObjectToken',
    'SPEI_INTERFERENCE', 'SPBO_NONE', 'SAFT32kHz16BitMono',
    'SPEI_SENTENCE_BOUNDARY', 'SAFT32kHz8BitMono',
    'DISPID_SPEDisplayAttributes', 'SPSHT_EMAIL',
    'ISpeechRecoContext', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPEI_TTS_BOOKMARK', 'SSFMOpenForRead', 'DISPID_SLPsCount',
    'DISPID_SGRSTsItem', 'DISPID_SWFEFormatTag',
    'SpPhraseInfoBuilder', 'SPEI_RESERVED1', 'SPWORDTYPE',
    'DISPID_SPPFirstElement', 'ISpeechLexiconWord',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPPsItem',
    'DISPID_SpeechGrammarRules', 'DISPID_SRAudioInput',
    'SPEI_TTS_PRIVATE', 'SPINTERFERENCE_TOOQUIET', 'SVP_12',
    'ISpMMSysAudio', 'SpObjectTokenCategory', 'SRTEmulated',
    'SAFT32kHz8BitStereo', 'eLEXTYPE_RESERVED6',
    'SAFTNoAssignedFormat', 'DISPID_SpeechPhraseProperties',
    'DISPID_SPCIdToPhone', 'DISPID_SRDisplayUI',
    'DISPID_SWFEExtraData', 'SpeechVisemeFeature',
    'DISPID_SPRNumberOfElements', 'SVP_21', 'SAFT48kHz16BitMono',
    'DISPID_SPERequiredConfidence', '_ISpeechRecoContextEvents',
    'ISpeechObjectTokenCategory', 'DISPID_SMSSetData',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpObjectTokenCategory',
    'DISPID_SGRsDynamic', 'DISPID_SRCSetAdaptationData', 'SDTRule',
    'DISPID_SpeechCustomStream', 'SVF_Emphasis', 'eLEXTYPE_APP',
    'SpeechPropertyNormalConfidenceThreshold',
    'ISpeechLexiconPronunciations', 'DISPID_SOTId', 'DISPID_SGRClear',
    'SRADefaultToActive', 'SpStream', 'SpObjectToken',
    'SpeechLexiconType', 'SPAUDIOSTATE',
    'SWPUnknownWordPronounceable', 'DISPID_SpeechPhraseInfo',
    'DISPID_SDKSetLongValue', 'DISPID_SRGDictationUnload',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPINTERFERENCE_NONE',
    'SPVPRI_NORMAL', 'DISPID_SRSSupportedLanguages', 'SP_VISEME_7',
    'SPEI_SOUND_START',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVWaitUntilDone', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVStatus', 'DISPID_SRCRetainedAudio',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_MORPHOLOGY',
    'SPEI_PHONEME', 'SPEI_RECO_STATE_CHANGE', 'SGRSTTRule',
    'DISPID_SRGId', 'DISPID_SPEsItem', 'DISPID_SPARecoResult',
    'SP_VISEME_19', 'SGRSTTEpsilon', 'DISPID_SPEEngineConfidence',
    'SPEI_SOUND_END', 'ISpeechWaveFormatEx', 'DISPID_SGRsCount',
    'DISPID_SAFType', 'SECFDefault', 'ISpEventSource', 'SPRECOSTATE',
    'SPEI_END_INPUT_STREAM', 'DISPID_SVAlertBoundary', 'SP_VISEME_16',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SOTGetDescription', '__MIDL_IWinTypes_0009',
    'DISPID_SRGRecoContext', 'SP_VISEME_11', 'DISPID_SGRs_NewEnum',
    'DISPID_SpeechPhraseAlternates', 'SPGRAMMARSTATE',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SWFEChannels',
    'DISPID_SABIBufferSize', 'SVEWordBoundary', 'SPSFunction',
    'SPSHORTCUTPAIR', 'DISPID_SRGReset', 'SVP_3',
    'SpNullPhoneConverter', 'SpStreamFormatConverter',
    'DISPID_SRCState', 'SVP_2', 'DISPID_SRRAlternates',
    'SpeechRecoContextState', 'DISPID_SpeechRecoResult2',
    'DISPID_SpeechVoice', 'DISPID_SDKGetlongValue',
    'DISPID_SMSGetData', 'DISPID_SRSCurrentStreamPosition',
    'SAFTADPCM_22kHzMono', 'DISPID_SGRSTPropertyName',
    'SpeechCategoryRecognizers', 'DISPID_SLPsItem',
    'DISPID_SVSLastBookmarkId', 'SVEViseme',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPERetainedSizeBytes',
    'SAFTADPCM_11kHzMono', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRRTimes', 'SRAImport', 'DISPID_SRSAudioStatus', 'SVP_10',
    'SAFT8kHz8BitMono', 'SPCS_DISABLED', 'DISPID_SPIElements',
    'SAFT16kHz16BitStereo', 'DISPID_SMSALineId', 'SLOStatic',
    'ISpAudio', 'tagSPTEXTSELECTIONINFO', 'DISPID_SRCRecognizer',
    'SRSActiveAlways', 'SAFT8kHz16BitStereo', 'SpeechAllElements',
    'DISPID_SLWWord', 'SLTApp', 'SRTStandard', 'SRAExport',
    'SRSInactive', 'SpeechAudioFormatGUIDWave', 'DISPID_SGRAddState',
    'SREPropertyNumChange', 'ISpeechPhoneConverter',
    'SpeechVoiceEvents', 'DISPID_SLPPhoneIds', 'DISPID_SPCPhoneToId',
    'SVP_13', 'ISpPhrase', 'DISPID_SRGetPropertyNumber',
    'eLEXTYPE_PRIVATE20', 'SAFT48kHz8BitStereo', 'SGSExclusive',
    'DISPID_SLWType', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SVSPhonemeId', 'SpeechDisplayAttributes',
    'DISPID_SpeechMemoryStream', 'SPPS_Unknown',
    'DISPID_SREmulateRecognition', 'SP_VISEME_20',
    'SAFT22kHz16BitStereo', 'DISPID_SLWsCount',
    'DISPID_SPIEnginePrivateData', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRState',
    'DISPID_SpeechXMLRecoResult', '_RemotableHandle', 'SPAR_Unknown',
    'DISPID_SABIEventBias', 'SPSUnknown', 'ISpRecoGrammar2',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPRules_NewEnum',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SRESoundStart',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPACommit',
    'ISpeechMMSysAudio', 'eLEXTYPE_VENDORLEXICON', 'SLODynamic',
    'DISPID_SpeechObjectToken', 'DISPID_SOTsCount',
    'DISPID_SOTCGetDataKey', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SpeechAudioStatus', 'DISPID_SOTCDefault',
    'DISPID_SWFEBlockAlign', 'SPADAPTATIONRELEVANCE',
    'SVEEndInputStream', 'DISPID_SVEViseme',
    'DISPID_SRGetPropertyString', 'DISPID_SGRSTNextState',
    'DISPID_SDKCreateKey', 'SPRST_INACTIVE', 'UINT_PTR',
    'DISPID_SABIMinNotification', 'SPCT_SUB_COMMAND',
    'SpeechGrammarWordType', 'ISpeechAudioStatus',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpeechVoice',
    'SPFM_OPEN_READWRITE', 'SPRST_ACTIVE_ALWAYS', 'SVP_15',
    'SPBO_AHEAD', 'DISPID_SPIGrammarId', 'SDTAlternates',
    'SPEI_ADAPTATION', 'DISPID_SRGIsPronounceable',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SVIsUISupported',
    'Speech_StreamPos_RealTime', 'SSFMCreate',
    'DISPID_SOTCreateInstance', 'SAFTCCITT_ALaw_22kHzMono',
    'SPLEXICONTYPE', 'SAFT32kHz16BitStereo',
    ...
    'SPPARTOFSPEECH', 'DISPID_SRIsShared', 'SVSFParseMask',
    'SGLexical', 'SBONone', 'SPAR_High',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_8', 'SPPS_Noun',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SOTDisplayUI',
    'DISPID_SPIReplacements', 'ISpXMLRecoResult', 'DISPID_SPIGetText',
    'IInternetSecurityMgrSite', 'DISPID_SVRate', 'DISPID_SPPsCount',
    ...
    'ISpeechRecoResultDispatch', 'SPEI_MAX_TTS',
    'SAFTGSM610_11kHzMono', 'SASClosed', 'SSTTDictation',
    'SRAInterpreter', 'DISPID_SRCEAdaptation',
    'DISPID_SABufferNotifySize', 'ISpeechXMLRecoResult',
    'SPPS_Interjection', 'DISPIDSPTSI_ActiveOffset',
    'SpSharedRecognizer', 'SPPS_Function', 'SPWF_SRENGINE',
    'STSF_LocalAppData', 'SpMemoryStream', 'SAFT22kHz8BitMono',
    'DISPID_SPIProperties', 'DISPID_SASNonBlockingIO',
    'SPSHT_NotOverriden', 'SAFTGSM610_44kHzMono', 'SPAS_RUN',
    ...
    'SPAUDIOBUFFERINFO', 'SRSEIsSpeaking', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRRDiscardResultInfo', 'ISpeechRecoGrammar', 'SPAO_NONE',
    'SPWT_PRONUNCIATION', 'DISPID_SDKDeleteValue', 'DISPID_SPRuleId',
    'eLEXTYPE_PRIVATE7', 'eLEXTYPE_RESERVED10',
    'ISpeechAudioBufferInfo', 'SAFT12kHz16BitMono', 'SPPHRASE',
    'SECFIgnoreWidth', 'DISPID_SOTCSetId', 'SVP_5',
    'DISPID_SGRInitialState', 'SASStop', 'DISPID_SpeechAudio',
    'DISPID_SpeechAudioFormat', 'SVP_6', 'eLEXTYPE_PRIVATE11',
    'SREAllEvents', 'SVP_1', 'SAFT22kHz8BitStereo', 'DISPID_SAFGuid',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechPartOfSpeech', 'SVF_Stressed',
    'DISPID_SPRuleFirstElement', 'SpeechRegistryUserRoot',
    'ISpeechMemoryStream', 'SPAS_CLOSED', 'DISPID_SAEventHandle',
    'DISPID_SpeechPhraseElement', 'SPFILEMODE',
    'SpeechCategoryRecoProfiles', 'eLEXTYPE_USER',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPRText',
    'DISPID_SRCEAudioLevel', 'DISPID_SASFreeBufferSpace',
    'STCLocalServer', 'DISPID_SRCBookmark', 'SVF_None',
    'SpeechVisemeType', 'STCInprocHandler',
    'DISPID_SpeechLexiconProns', 'DISPID_SPANumberOfElementsInResult',
    'ISpPhoneticAlphabetConverter', 'DISPID_SGRsCommit',
    'DISPID_SPPValue', 'SVSFPersistXML', 'SVP_17',
    'eLEXTYPE_PRIVATE5', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SpeechRecoContext',
    'SpeechCategoryVoices', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SADefaultFormat', 'SpeechPropertyAdaptationOn',
    'SAFTCCITT_ALaw_44kHzMono', 'SVSFlagsAsync', 'SGPronounciation',
    'SPEI_VOICE_CHANGE', 'SPEI_RESERVED2', 'SP_VISEME_4',
    'ISpSerializeState', 'DISPID_SRCERecognition', 'SPEI_SR_BOOKMARK',
    'SVEAudioLevel', 'SpeechAudioProperties', 'SpeechWordType',
    'SpeechAddRemoveWord', 'DISPID_SRRTTickCount', 'SpeechRuleState',
    'SPCT_SLEEP', 'DISPID_SVPause', 'DISPID_SVSkip', 'ISpNotifySink',
    'IEnumSpObjectTokens', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPSHORTCUTPAIRLIST', 'SRAORetainAudio', 'SGDSActive',
    'SpeechBookmarkOptions', 'SGSDisabled', 'SVSFParseSapi', 'STCAll',
    'DISPID_SGRSTransitions', 'SPEI_WORD_BOUNDARY',
    'SpeechRetainedAudioOptions', 'DISPID_SRRSaveToMemory',
    'SP_VISEME_17', 'ISpeechRecoResultTimes', 'SpeechInterference',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SAFT16kHz16BitMono',
    'DISPID_SVAudioOutput', 'DISPID_SRRTStreamTime',
    'SpeechTokenKeyAttributes', 'DISPID_SGRSTWeight',
    'SPPROPERTYINFO', 'SPAR_Low', 'STCRemoteServer', 'ISpStream',
    'DISPID_SRCEStartStream', 'SSSPTRelativeToEnd',
    'DISPID_SGRAddResource', 'SRSEDone', 'SPEI_VISEME',
    'ISpeechLexiconPronunciation', 'DISPID_SDKEnumValues',
    'SPINTERFERENCE_TOOFAST', 'SPSEMANTICERRORINFO',
    'SAFTCCITT_ALaw_11kHzMono', 'SRERequestUI', 'IEnumString',
    'SpeechCategoryPhoneConverters', 'SP_VISEME_12',
    'SPTEXTSELECTIONINFO', 'SAFTCCITT_uLaw_11kHzStereo',
    'ISpPhoneticAlphabetSelection', 'eLEXTYPE_USER_SHORTCUT',
    'SpNotifyTranslator', 'SVP_14', 'SRTAutopause',
    'DISPID_SPEAudioTimeOffset', 'SpLexicon', 'SPEI_END_SR_STREAM',
    'SSFMOpenReadWrite', 'ISpeechVoiceStatus', 'SPCT_DICTATION',
    ...
    'DISPID_SPEDisplayText', 'SVP_9', 'SPEI_SR_PRIVATE',
    'DISPID_SPRsItem', 'SAFT24kHz8BitStereo',
    'ISpeechPhraseReplacements', 'DISPID_SRSetPropertyString',
    'SRSInactiveWithPurge', 'SpeechWordPronounceable',
    'DISPID_SVSLastResult', 'SPFM_CREATE_ALWAYS',
    'DISPID_SPRDisplayAttributes', 'SVP_18',
    'DISPID_SRCCmdMaxAlternates', 'SREPhraseStart',
    'DISPID_SpeechGrammarRule', 'STSF_AppData', 'SPAO_RETAIN_AUDIO',
    'DISPID_SGRsItem', 'SAFTCCITT_uLaw_44kHzMono', 'SPPHRASEPROPERTY',
    'DISPID_SLGetGenerationChange', 'SPWF_INPUT', 'SPXRO_SML',
    'SVEPhoneme', 'DISPID_SpeechWaveFormatEx', 'SPBO_PAUSE',
    'SAFTCCITT_uLaw_11kHzMono', 'SPINTERFERENCE_LATENCY_WARNING',
    'Speech_Max_Pron_Length', 'SVSFIsFilename',
    'ISpeechTextSelectionInformation', 'SREAdaptation',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SGRAttributes',
    'DISPID_SAFGetWaveFormatEx', 'SpeechTokenContext', 'SVP_4',
    'DISPID_SGRsCommitAndSave', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechPhraseAlternate', 'SECFEmulateResult',
    'SDA_Consume_Leading_Spaces', 'SECLowConfidence', 'SGSEnabled',
    'SPPS_RESERVED2', 'ISpPhraseAlt', 'DISPID_SpeechRecoResult',
    'SWTDeleted', 'ISpProperties', 'SPCATEGORYTYPE', 'tagSTATSTG',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRGCmdLoadFromObject',
    'SVPOver', 'SP_VISEME_18', 'SAFT8kHz16BitMono',
    'ISpeechCustomStream', 'SpMMAudioOut', 'eLEXTYPE_PRIVATE8',
    'SDTAll', 'ISpeechPhraseAlternates', 'DISPID_SPIAudioSizeBytes',
    'SpInprocRecognizer', 'DISPID_SRCEventInterests',
    'SpeechGrammarTagWildcard', 'SPPS_Noncontent',
    'ISpObjectWithToken', 'eLEXTYPE_RESERVED8', 'SDTProperty',
    'SPBOOKMARKOPTIONS', 'SpeechRecognitionType',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPGS_DISABLED',
    'ISpEventSink', 'SPEI_RESERVED5', 'eLEXTYPE_PRIVATE13',
    'SFTInput', 'ISpeechRecoResult', 'ISpeechPhraseInfo', 'SVP_19',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SBSWrite', 'SGRSTTWord',
    'SPSVerb', 'DISPID_SpeechVoiceStatus',
    'SpTextSelectionInformation', 'SPVPRI_ALERT', 'SPRULE',
    'DISPID_SRRAudioFormat', 'SAFT11kHz16BitStereo', 'SP_VISEME_10',
    'DISPID_SGRSTType', 'SPEVENTSOURCEINFO', 'DISPID_SPISaveToMemory',
    'ISpPhoneConverter', 'DISPID_SVEStreamStart', 'ISpeechFileStream',
    'DISPID_SVSInputSentencePosition', 'SPRECORESULTTIMES',
    'ISpeechObjectTokens', 'SpeechVoiceSpeakFlags', 'SRTSMLTimeout',
    'SAFT48kHz8BitMono', 'ISpStreamFormatConverter', 'SVP_11',
    'DISPID_SOTRemove', 'SPVISEMES', 'SPAR_Medium',
    'SPSERIALIZEDRESULT', 'DISPID_SRRRecoContext',
    'ISpeechPhraseAlternate', 'SAFT16kHz8BitMono',
    'DISPID_SLGetPronunciations', 'DISPID_SRGState', 'SPPS_LMA',
    'SpeechTokenShellFolder', 'DISPID_SRGCmdSetRuleIdState',
    'SAFT24kHz16BitMono', 'DISPID_SPAsItem',
    'DISPID_SASCurrentDevicePosition', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SVEBookmark', 'DISPID_SPEAudioSizeTime',
    'ISpeechBaseStream', 'eLEXTYPE_RESERVED7',
    'DISPID_SVSRunningState', 'SAFT12kHz8BitMono',
    'eLEXTYPE_PRIVATE3', 'ISpDataKey', 'SpeechPropertyResponseSpeed',
    'eWORDTYPE_DELETED', 'SVP_7', 'eLEXTYPE_PRIVATE10',
    'SAFT44kHz8BitMono', 'eLEXTYPE_PRIVATE16', 'SVEBookmark',
    'ISpRecoResult', 'SPRULESTATE', 'SRADynamic',
    'SDA_Two_Trailing_Spaces'
]

_check_version('1.1.14', 1654705357.646875)
